...
test_that("hurdle - classification", {
  ...
  # expect_equal(
  #   .pluck_num_parameters(fit_reg_hurdle)$value,
  #   length(coefs)
  # )
  ...
  expect_equal(
    .pluck_features_active(fit_reg_hurdle)$value[[1]],
    act_vars
  )
  expect_equal(
    .pluck_num_features_active(fit_reg_hurdle)$value,
    length(act_vars)
  )
  # expect_equal(
  #   .pluck_num_features_input(fit_reg_hurdle)$value,
  #   ncol(attr(fit_reg_hurdle$terms, "factors"))
  # )
})
