...
test_that("C5.0", {
  ...
  expect_equal(
    .pluck_num_active_features(c5_mod)$value,
    exp_act_feat_c5
  )
  ...
  expect_equal(
    .pluck_num_active_features(c5_rules_mod)$value,
  ...
  expect_equal(
    .pluck_num_active_features(c5_boost_mod)$value,
  ...
  expect_equal(
    .pluck_num_active_features(c5_rules_boost_mod)$value,
